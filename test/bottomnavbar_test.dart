...
void main() {
  testWidgets('bottomnavbar_hasToShowTitleAndMenuIcon', (WidgetTester tester) async {
  ...
  testWidgets('bottomnavbar_hasToShowTitleAndArrowBackIcon', (WidgetTester tester) async {
  ...
  testWidgets('bottomnavbar_hasToNotShowingTitleAndArrowBackIcon', (WidgetTester tester) async {
  ...
  testWidgets('bottomnavbar_hasToShowCircleAvatar', (WidgetTester tester) async {
    await tester.pumpWidget(MediaQuery(data: MediaQueryData(), child: MaterialApp(home: FlatAppBar(showBackButton: true, showTitle: false, showSubtitle: true,))));
